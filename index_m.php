...
require_once dirname(__DIR__) . '/estudiantes_app/controllers/materia_controller.php';
        ...
        <tbody>
            ...
            if (count($materias) > 0){
                foreach($materias as $materia) {
                    ...
                    echo '<td>' . $materia->get('nombres') . '' ;
                    echo '<td>' . $materia->get('codigo') . '</td>';
                    echo '<td>' ; 
                    echo '  <a href="form_Materias.php?idE=' . $materia->get('id') . '">Modificar</a>';
                    echo '</td>';
                    echo '<td>';
                    echo '  <a href="eliminar.php?idE=' . $materia->get('id') . '">Eliminar</a>';
                    echo '</td>';
                    echo '</tr>';
                }
            }else{
